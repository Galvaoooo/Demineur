...
namespace Minesweeper
{
    class Program
    {
        ...
        static void ChiffresCornerHautDroit(int[,] tab2D, int nbrLignes, int nbrColonnes)
        {
            int i = nbrLignes -1;
            int j = 0;
        ...
        static void ChiffresCornerHautGauche(int[,] tab2D, int nbrLignes, int nbrColonnes)
        {
            int i = 0;
            int j = 0;
        ...
        static void ChiffresCornerBasGauche(int[,] tab2D)
        {
            int i = 7;
            int j = 8;
        ...
        static void ChiffresCornerBasDroit(int[,] tab2D)
        {
            int i = 7;
            int j = 8;
        ...
        static void ChiffresMid(int[,] tab2D, int nbrLignes)
        {
            for (int j = 1; j < nbrLignes - 1; j++)
            {
                for (int i = 1; i < nbrLignes - 1; i++)
                {
                    if (tab2D[i, j] != nbrLignes)
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                if (choix == "1")
                {
                    ...
                    Show(tab2D);
                    ChiffresCornerHautDroit(tab2D, nbrLignes, nbrColonnes);
                    ChiffresCornerHautGauche(tab2D, nbrLignes, nbrColonnes);
                    ChiffresCornerBasDroit(tab2D);
                    ChiffresCornerBasGauche(tab2D);
